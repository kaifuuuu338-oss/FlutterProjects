...
class AppConstants {
  ...
  static const Map<String, List<String>> apDistrictMandals = {
    ...
    'Dr. B.R. Ambedkar Konaseema': ['Amalapuram', 'Mummidivaram', 'Allavaram', 'Razole'],
    'East Godavari': ['Rajamahendravaram Rural', 'Kadiam', 'Seethanagaram', 'Rajanagaram'],
    ...
    'Parvathipuram Manyam': ['Parvathipuram', 'Palakonda', 'Seethampeta', 'Kurupam'],
    ...
    'Visakhapatnam': ['Visakhapatnam Urban', 'Bheemunipatnam', 'Anandapuram', 'Pendurthi'],
    'Vizianagaram': ['Vizianagaram', 'Gajapathinagaram', 'Bobbili', 'Cheepurupalle'],
    'West Godavari': ['Bhimavaram', 'Narasapuram', 'Palacole', 'Tadepalligudem'],
